...
<section style="margin-top: 100px; padding: 60px 0; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
  <div class="container">
    <h1 data-aos="fade-up" style="font-size: 2.5rem;">Ajouter une Competence</h1>
    <p data-aos="fade-up" data-aos-delay="100">Decrivez votre domaine d'expertise</p>
  </div>
</section>
            ...
            <form action="{{ route('skills.store') }}" method="POST">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                       id="name" name="name" placeholder="Ex: PHP, JavaScript, Design UI/UX" required 
                       value="{{ old('name') }}" style="border-radius: 10px; border: 2px solid #e0e0e0;">
                @error('name')
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <input type="text" class="form-control @error('category') is-invalid @enderror" 
                         id="category" name="category" placeholder="Ex: Programmation, Design" required 
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <select class="form-select @error('level') is-invalid @enderror" 
                    ...
                    <option value="Debutant" {{ old('level') == 'Debutant' ? 'selected' : '' }}>Debutant</option>
                    <option value="Intermediaire" {{ old('level') == 'Intermediaire' ? 'selected' : '' }}>Intermediaire</option>
                    <option value="Avance" {{ old('level') == 'Avance' ? 'selected' : '' }}>Avance</option>
