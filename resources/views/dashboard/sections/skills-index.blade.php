<div class="content-section">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="action-btn action-btn-edit" data-action="view" data-type="skills" data-id="{{ $skill->id }}">
    ...
    @else
        <div class="empty-state">
            ...
            <p>No skills yet. <a href="#" onclick="loadSection('skills-create'); return false;">Create one</a></p>
        </div>
    @endif
</div>
