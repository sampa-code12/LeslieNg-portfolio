...
<section style="margin-top: 100px; padding: 60px 0; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
  <div class="container">
    <h1 data-aos="fade-up" style="font-size: 2.5rem;">Éditer le Service</h1>
    <p data-aos="fade-up" data-aos-delay="100">Modifiez les détails du service</p>
  </div>
</section>
            ...
            <form action="{{ route('services.update', $service->id) }}" method="POST">
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <input type="text" class="form-control @error('title') is-invalid @enderror" 
                         ...
                         value="{{ old('title', $service->title) }}" style="border-radius: 10px; border: 2px solid #e0e0e0;">
                  @error('title')
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <input type="text" class="form-control @error('category') is-invalid @enderror" 
                         ...
                         value="{{ old('category', $service->category) }}" style="border-radius: 10px; border: 2px solid #e0e0e0;">
                  @error('category')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                       id="slug" name="slug" 
                       value="{{ old('slug', $service->slug) }}" style="border-radius: 10px; border: 2px solid #e0e0e0;">
                @error('slug')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="mb-4">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          style="border-radius: 10px; border: 2px solid #e0e0e0;">{{ old('description', $service->description) }}</textarea>
                @error('description')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
              </div>
